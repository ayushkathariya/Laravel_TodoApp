            ...
            <div class="row">
                <div class="col-lg-6 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('admin.todos') }}" class="small-box-footer">More info <i
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="{{ asset('AdminLTE/direct-chat-img" src="dist/img/user1-128x128.jpg') }}"
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="{{ asset('AdminLTE/direct-chat-img" src="dist/img/user3-128x128.jpg') }}"
                                        alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
